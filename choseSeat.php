...
if (isset($_POST['endOrder'])) {
    ...
    echo '<script>alert("Payment success ! Thank you for coming to us");</script>';
    addOrder();
...
<body>
    ...
    <div class="icon-ticket" <?php if ($_SESSION['login'] == true) {
            ...
            <small class="num-ticket">(<?php countQuantityOrderById($_SESSION['id_cus']) ?>)</small>
            </a>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-striped" id="tblGrid">
                        ...
                        <tbody>
                            <?php
                           if(isset($_SESSION['id_cus'])){ getFilmByIdUser($_SESSION['id_cus']);}
                            ?>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="container" style="margin-top: 100px">
        ...
        <div class="seat-screen">
            <div class="item-screen">
                ...
                <div style="display: flex">
                    <?php displayNumberOfSeat('normal', 'A',$_SESSION['id_cinema']) ?>
                </div>
            </div>
            <div class="item-screen">
                <div class="stt-screen"><span>B</span></div>
                <div style="display: flex">
                    <?php displayNumberOfSeat('normal', 'B',$_SESSION['id_cinema']) ?>
                </div>
            </div>
            <div class="item-screen">
                ...
                <div style="display: flex">
                    <?php displayNumberOfSeat('normal', 'C',$_SESSION['id_cinema']) ?>
                </div>
            </div>
            <div class="seat-vip">
                <div class="item-screen">
                    ...
                    <div style="display: flex">
                        <?php displayNumberOfSeat('vip', 'D',$_SESSION['id_cinema']) ?>
                    </div>
                </div>
            </div>
            ...
            <div class="seat-vip">
                <div class="item-screen">
                    ...
                    <div style="display: flex">
                        <?php displayNumberOfSeat('vip', 'E',$_SESSION['id_cinema']) ?>
                    </div>
                </div>
            </div>
            <div class="seat-couple">
                <div class="item-screen">
                    ...
                    <div style="display: flex">
                        <?php displayNumberOfSeat('couple', 'F',$_SESSION['id_cinema']) ?>
                    </div>
                </div>
            </div>
        </div>
        <div class="title-seat">
            ...
            <button style="margin-left: 50px" class="seat-can"></button><span>Seat can choose</span>
            <button class="seat-selected">X</button><span>Seat Bought</span>
