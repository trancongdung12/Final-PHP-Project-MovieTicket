...
if (isset($_GET['mostView'])) {
    $_SESSION['id_film'] = $_GET['mostView'];
    $sql = "SELECT *  FROM film where id =" . $_GET['mostView'];
    $rs = $connect->query($sql);

    while ($row = $rs->fetch_assoc()) {
        $_SESSION['name_film'] = $row['name_film'];
    }
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="list-screen">
                            ...
                            { 
                                countQuantitySeat($_SESSION['id_cinema']);
                    ...
                    <div class="modal-footer">
                        <form method="post"><button type="submit" name="checkLogin" class="btn btn-danger" style="background-color: #f60;">
                                <a style="text-decoration: none;color:white" <?php if ($_SESSION['login'] == true && $_SESSION['getCinema'] != null) {
                                                                                    echo ' href="choseSeat.php" ';
                                                                                } ?>>OK</a></button>
                            <?php
