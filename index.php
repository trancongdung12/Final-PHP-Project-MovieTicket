...
<?php if(isset($_POST['close-mes'])){
    ...
    <div class="container">
        ...
        <div class="row">
            <div id="carousel-come" class="carousel slide" data-ride="carousel-come">
                ...
                <a class="carousel-control-prev" href="#carousel-come" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#carousel-come" role="button" data-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    <span class="sr-only">Next</span>
                </a>
            </div>
